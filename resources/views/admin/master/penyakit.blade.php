<x-admin.template-admin :title="$judul" :menu-utama="$menuUtama" :menu-kedua="$menuKedua">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Master Data Penyakit</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('adm.master.penyakit.save')}}" method="post">
                    @csrf
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <label for="namaPenyakit"
                                      @class(["form-label","errorLabel",($errors->tambah->has('nama'))? "text-danger":""]) >Nama Penyakit
                                </label>
                                <input type="text" name="name" maxlength="125"
                                       @class(["form-control","errorInput",($errors->tambah->has('name'))? "is-invalid":""]) value="{{old('name')}}"
                                       id="namaPenyakit" placeholder="Nama Penyakit">
    ...
    <script>
        ...
        $(document).ready(function () {
            let base_url = "{{route('adm.master.penyakit')}}";
            $('#tabel1').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
