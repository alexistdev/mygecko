<x-admin.template-admin :title="$judul" :menu-utama="$menuUtama" :menu-kedua="$menuKedua">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Master Data Gejala</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
{{--                    <x-notify-messages />--}}
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('adm.basispengetahuan.save')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <!-- Start: Nama Penyakit -->
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <label for="penyakit_idtambah"
                                      @class(["form-label","errorLabel",($errors->tambah->has('penyakit_id'))? "text-danger":""]) >Nama Penyakit
                                </label>
                                ...
                                @if($errors->tambah->has('penyakit_id'))
                                    <span
                                        class="text-danger errorMessage">{{$errors->tambah->first('penyakit_id')}}</span>
                                @endif
                            </div>
                        </div>
                        <!-- End: Nama Penyakit -->
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <label for="gejala_idtambah"
                                    @class(["form-label","errorLabel",($errors->tambah->has('gejala_id'))? "text-danger":""]) >Nama Gejala
                                </label>
                                ...
                                @if($errors->tambah->has('gejala_id'))
                                    <span
                                        class="text-danger errorMessage">{{$errors->tambah->first('gejala_id')}}</span>
                                @endif
                            </div>
                        </div>
                        <!-- End: Nama Gejala -->
    ...
    <script>
        ...
        $(document).ready(function () {
            let base_url = "{{route('adm.basispengetahuan')}}";
            $('#tabel1').DataTable({
                responsive: true,
                processing: true,
                serverSide: true,
